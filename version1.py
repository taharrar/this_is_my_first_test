...
class EduEvaluationApp:
    ...
    def show_results(self):
        ...
        if not results:
            ...
            columns = ('Test nomi', "O'quvchi", "To'g'ri javoblar", "Foiz", "Holat", "Vaqt")
            ...
            for row in results:
                ...
                tag = 'passed' if row[4] else 'failed'
                tree.insert('', END, values=(row[0], row[1], row[2], f"{row[3]:.1f}%", holat, row[5]), tags=(tag,))
